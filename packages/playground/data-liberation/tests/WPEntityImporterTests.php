...
/**
 * Tests for the WP_Entity_Importer class.
 */
class WPEntityImporterTests extends PlaygroundTestCase {

	protected function setUp(): void {
		parent::setUp();

		$this->markTestSkipped( 'Skipped test until https://github.com/WordPress/wordpress-playground/pull/2030 is merged' );
