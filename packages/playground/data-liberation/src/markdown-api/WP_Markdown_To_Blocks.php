...
class WP_Markdown_To_Blocks {
	...
	static public function convert($markdown) {
    ...
    private function push_block($name, $attributes = [], $innerBlocks = []) {
    ...
    private function create_block($name, $attributes = [], $innerBlocks = []) {
...
class WP_Block_Object {
    ...
    public function __construct($blockName, $attrs = [], $innerBlocks = []) {
	...
	public function as_array() {
		...
		return [
			...
			'attrs' => $attrs,
			'innerBlocks' => array_map(function($block) {
